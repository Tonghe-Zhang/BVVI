...
def BVVI(model_true:tuple,
    ...
    '''
    inputs: 
        model_true: the kernels of the true environment. (mu, T, O) trinary tensor tuple. 
        reward_true: the reward matrices of the true environmet. 3D tensor
